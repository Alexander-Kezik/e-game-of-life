...
Matrix should have any number of columns between 20 and 30 and any number of rows between 20 and 30. Then comes single number number of iteration to generate between 1 and 1000. 
